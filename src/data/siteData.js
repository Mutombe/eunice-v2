...
// === Mock programmes — only used when VITE_MOCK_DATA=true (palette previews).
// Mirrors the seed in backend/seed_programmes.py so the previews render the
// same three programme cards as production. */
export const mockProgrammes = [
  {
    slug: 'reinvention',
    num: '01',
    title: 'Reinvention',
    italicTitle: 'for women in second seasons',
    ...
    imageCaption: 'On the mountain trail',
    ctaLabel: 'Apply to Reinvention',
    ctaTo: '/enquire?subject=programme-reinvention',
    featured: true,
    order: 0,
  },
  {
    ...
    italicTitle: 'for founders rebuilding after burnout',
    discipline: 'Coaching · eight weeks · executive',
    lede: 'An eight-week recovery practice for founders and senior leaders who have walked into a wall and would like to know what to do with the broken bits.',
    ...
    imageCaption: 'Mountain · still water',
    ctaLabel: 'Apply to Considered Recovery',
    ctaTo: '/enquire?subject=programme-recovery',
    featured: false,
    order: 1,
  },
  {
    ...
    italicTitle: 'for a house that should hold a person',
    discipline: 'Hybrid · six weeks · interiors + coaching',
    lede: "The studio's hybrid offering — six weeks of paired coaching and on-site interior audit, designing a household around the person rebuilding inside it.",
    duration: 'Six weeks',
    ...
    imageCaption: 'A morning table',
    ctaLabel: 'Apply for the Audit',
    ctaTo: '/enquire?subject=programme-audit',
    featured: true,
    order: 2,
  },
]
